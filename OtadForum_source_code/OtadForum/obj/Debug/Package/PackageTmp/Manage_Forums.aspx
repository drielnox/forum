<%@ Page Title="Manage Forums" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Manage_Forums.aspx.cs" Inherits="OtadForum.Manage_Forums" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Panel ID="PanelLogin" runat="server" Height="199px">
        ...
        <div style="width: 572px; height: 173px;">
            <strong>Forum Admin Athentication:<br /> </strong>
            <br />
            Username:<br />
    ...
    <asp:Panel ID="PanelForums" runat="server" Height="287px" Visible="False">
        <span class="style3">Manage Forums<br /> </span>&nbsp;<div style="height: 216px">
