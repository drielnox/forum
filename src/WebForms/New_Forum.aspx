<%@ Page Title="Create New Forum" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="New_Forum.aspx.cs" Inherits="OtadForum.New_Forum" %>
...
<asp:Panel ID="PanelForum" runat="server" Height="241px" Visible="False">
    <strong>Create a new Forum<br /> </strong>
    <br />
    <div>
        Forum Name:<br />
