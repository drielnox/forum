<%@ Page Title="Start New Discussion" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="New.aspx.cs" Inherits="drielnox.Forum.Presetation.WebForms.Discussions.NewDiscussion" %>
